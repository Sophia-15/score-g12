...
def infinity_runner():
  ...
  x_change = 0
  gravity = 1.2
  obstacles = [monitor_size[0] - 100, monitor_size[0], monitor_size[0] + 150]
  obstacles_speed = 3
  active = True
  score = 0
  ...
  while running:
      ...
      for i in range(len(obstacles)):
          if active:
              ...
              if obstacles[i] < -20:
                  obstacles[i] = random.randint(monitor_size[0] - monitor_size[0], monitor_size[0] - monitor_size[0] )
                  score += 1
                  ...
                  if obstacles0.colliderect(obstacles1) or obstacles2.colliderect(obstacles2):
                    obstacles[i] = random.randint(monitor_size[0] - monitor_size[0], monitor_size[0] - monitor_size[0] - monitor_size[0])
